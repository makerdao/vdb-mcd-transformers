...
--
-- Name: ilk_dunk_before_block(integer, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.ilk_dunk_before_block(ilk_id integer, header_id integer) RETURNS numeric
    LANGUAGE sql
    AS $$
WITH passed_block_number AS (
    SELECT block_number
...
--
-- Name: FUNCTION ilk_dunk_before_block(ilk_id integer, header_id integer); Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON FUNCTION public.ilk_dunk_before_block(ilk_id integer, header_id integer) IS '@omit';
...
--
-- Name: ilk_snapshot_updated_idx; Type: INDEX; Schema: api; Owner: -
--
