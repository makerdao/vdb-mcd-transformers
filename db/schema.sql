...
--
-- Name: mark_noncanonical_transformed_diff_as_pending(bigint); Type: FUNCTION; Schema: maker; Owner: -
--

CREATE FUNCTION maker.mark_noncanonical_transformed_diff_as_pending(diff_id bigint) RETURNS void
    LANGUAGE plpgsql
    AS $$
    BEGIN
