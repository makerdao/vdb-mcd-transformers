...
(
    ...
    UNIQUE (header_id, address_id, bid_id, bid)
);
...
(
    ...
    UNIQUE (header_id, address_id, bid_id, lot)
);
...
(
    ...
    bid_id     NUMERIC NOT NULL,
    guy        TEXT    NOT NULL,
    UNIQUE (header_id, address_id, bid_id, guy)
);
...
(
    ...
    bid_id     NUMERIC NOT NULL,
    tic        BIGINT  NOT NULL,
    UNIQUE (header_id, address_id, bid_id, tic)
);
...
(
    ...
    bid_id     NUMERIC NOT NULL,
    "end"      BIGINT  NOT NULL,
    UNIQUE (header_id, address_id, bid_id, "end")
);
...
(
    ...
    address_id INTEGER NOT NULL REFERENCES addresses (id) ON DELETE CASCADE,
    gem        TEXT    NOT NULL,
    UNIQUE (header_id, address_id, gem)
);
...
(
    ...
    UNIQUE (header_id, address_id, live)
);
