...
ALTER TABLE checked_headers
 ALTER COLUMN pip_log_value_checked TYPE integer USING CASE WHEN false THEN 0 ELSE 1 END,
 ...
 ALTER COLUMN jug_file_base_checked TYPE integer USING CASE WHEN false THEN 0 ELSE 1 END,
 ...
 ALTER COLUMN cat_file_vow_checked TYPE integer USING CASE WHEN false THEN 0 ELSE 1 END,
...
ALTER TABLE checked_headers
 ...
 ALTER COLUMN pip_log_value_checked SET DATA TYPE boolean USING CASE WHEN pip_log_value_checked = 0 THEN FALSE ELSE TRUE END,
 ...
 ALTER COLUMN jug_file_base_checked SET DATA TYPE boolean USING CASE WHEN jug_file_base_checked = 0 THEN FALSE ELSE TRUE END,
 ...
 ALTER COLUMN cat_file_vow_checked SET DATA TYPE boolean USING CASE WHEN cat_file_vow_checked = 0 THEN FALSE ELSE TRUE END,
