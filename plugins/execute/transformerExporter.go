...
import (
	...
	cat_file_chop_dunk "github.com/makerdao/vdb-mcd-transformers/transformers/events/cat_file/chop_dunk/initializer"
...
func (e exporter) Export() ([]event.TransformerInitializer, []storage.TransformerInitializer, []interface1.ContractTransformerInitializer) {
	return []event.TransformerInitializer{
			...
			cat_file_chop_dunk.EventTransformerInitializer,
