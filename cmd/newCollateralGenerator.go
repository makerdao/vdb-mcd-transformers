...
func addNewCollateral() error {
	...
	configUpdater := config.NewConfigUpdater(collateral, contracts)
	newCollateralGenerator := generator.NewCollateralGenerator{
		ConfigFileName: "mcdTransformers",
		ConfigFilePath: "/Users/elizabethengelman/go/src/github.com/makerdao/vdb-mcd-transformers/environments/",
