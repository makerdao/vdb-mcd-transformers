...
const (
	BidId     vdbStorage.Key = "bid_id"
	Cdpi      vdbStorage.Key = "cdpi"
	Flip      vdbStorage.Key = "flip"
	Guy       vdbStorage.Key = "guy"
	Ilk       vdbStorage.Key = "ilk"
	Owner     vdbStorage.Key = "owner"
	Timestamp vdbStorage.Key = "timestamp"
)
