...
var _ = Describe("Signature constants", func() {
	...
	It("generates jug init signature", func() {
		Expect(JugInitSignature()).To(Equal("0x000000000000000000000000000000000000000000000000000000003b663195"))
	})
	...
	It("generates vat fork signature", func() {
		Expect(VatForkSignature()).To(Equal("0x00000000000000000000000000000000000000000000000000000000870c616d"))
	})
