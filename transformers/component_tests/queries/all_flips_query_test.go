...
var _ = Describe("All flips view", func() {
	...
	It("gets the latest state of every bid on the flipper", func() {
		...
		test_helpers.CreateFlip(db, 0, headerOne, flipStorageValuesOne, test_helpers.GetFlipMetadatas(strconv.Itoa(fakeBidId)), contractAddress)
		...
		test_helpers.CreateFlip(db, 0, headerTwo, flipStorageValuesTwo, test_helpers.GetFlipMetadatas(strconv.Itoa(fakeBidId)), contractAddress)
		...
		test_helpers.CreateFlip(db, 0, headerTwo, flipStorageValuesThree, test_helpers.GetFlipMetadatas(strconv.Itoa(fakeBidId2)), contractAddress)
	...
	It("ignores bids from other contracts", func() {
		...
		test_helpers.CreateFlip(db, 0, headerOne, flipStorageValues, test_helpers.GetFlipMetadatas(strconv.Itoa(fakeBidId)), contractAddress)
		...
		test_helpers.CreateFlip(db, 0, headerOne, irrelevantFlipValues, test_helpers.GetFlipMetadatas(strconv.Itoa(irrelevantBidId)), irrelevantAddress)
	...
	It("gets the all flip bids when there are multiple flip contracts", func() {
		...
		test_helpers.CreateFlip(db, 0, headerOne, flipStorageValuesOne, test_helpers.GetFlipMetadatas(strconv.Itoa(bidIdOne)), contractAddress)
		...
		test_helpers.CreateFlip(db, 0, headerTwo, flipStorageValuesTwo, test_helpers.GetFlipMetadatas(strconv.Itoa(bidIdTwo)), anotherFlipAddress)
	...
	Describe("result pagination", func() {
		...
		BeforeEach(func() {
			...
			test_helpers.CreateFlip(db, 0, headerOne, flipOneStorageValues, test_helpers.GetFlipMetadatas(strconv.Itoa(fakeBidIdOne)), contractAddress)
			...
			test_helpers.CreateFlip(db, 0, headerOne, flipTwoStorageValues, test_helpers.GetFlipMetadatas(strconv.Itoa(fakeBidIdTwo)), contractAddress)
		})
