...
var _ = Describe("Ilk State Query", func() {
	...
	Describe("handles getting the most recent Ilk values as of a given block", func() {
		...
		It("gets the Ilk for block two", func() {
			...
			vatMetadatasWithoutRateOrArt := []types.ValueMetadata{test_helpers.FakeIlkSpotMetadata, test_helpers.FakeIlkLineMetadata}
		...
		It("gets the Ilk for block three", func() {
			...
			vatMetadatasWithoutArt := []types.ValueMetadata{test_helpers.FakeIlkRateMetadata, test_helpers.FakeIlkSpotMetadata, test_helpers.FakeIlkLineMetadata}
		...
		It("gets more than one ilk as of block three", func() {
			...
			blockThreeFakeIlkValues := test_helpers.GetIlkValues(3)
			vatMetadatasWithoutRate := []types.ValueMetadata{test_helpers.FakeIlkArtMetadata, test_helpers.FakeIlkSpotMetadata, test_helpers.FakeIlkLineMetadata}
