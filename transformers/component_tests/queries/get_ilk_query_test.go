...
var _ = Describe("Ilk State Query", func() {
	...
	It("returns the correct data if there are several ilks", func() {
		...
		test_helpers.CreateIlk(db, headerOne, ilkValues, test_helpers.FakeIlkVatMetadatas, test_helpers.FakeIlkCatMetadatas, test_helpers.FakeIlkJugMetadatas, test_helpers.FakeIlkSpotMetadatas)
		test_helpers.CreateIlk(db, headerOne, anotherIlkValues, test_helpers.AnotherFakeIlkVatMetadatas, test_helpers.AnotherFakeIlkCatMetadatas, test_helpers.AnotherFakeIlkJugMetadatas, test_helpers.AnotherFakeIlkSpotMetadatas)
	...
	Describe("handles getting the most recent Ilk values as of a given block", func() {
		It("gets the Ilk for block one", func() {
			...
			test_helpers.CreateIlk(db, headerOne, fakeIlkvalues, test_helpers.FakeIlkVatMetadatas, test_helpers.FakeIlkCatMetadatas, test_helpers.FakeIlkJugMetadatas, test_helpers.FakeIlkSpotMetadatas)
		...
		It("gets the Ilk for block two", func() {
			...
			vatMetadatasWithoutRateOrArt := []vdbStorage.StorageValueMetadata{test_helpers.FakeIlkSpotMetadata, test_helpers.FakeIlkLineMetadata}
			...
			blockTwoExpectedIlk := test_helpers.IlkState{
				Rate: blockOneFakeIlkValues[vat.IlkRate].(string), // value hasn't changed since block 1
				Art:  blockOneFakeIlkValues[vat.IlkArt].(string),  // value hasn't changed since block 1
				Spot: blockTwoFakeIlkValues[vat.IlkSpot].(string),
				Line: blockTwoFakeIlkValues[vat.IlkLine].(string),
			}
		...
		It("gets the Ilk for block three", func() {
			...
			vatMetadatasWithoutArt := []vdbStorage.StorageValueMetadata{test_helpers.FakeIlkRateMetadata, test_helpers.FakeIlkSpotMetadata, test_helpers.FakeIlkLineMetadata}
			...
			blockThreeExpectedIlk := test_helpers.IlkState{
				Rate: blockThreeFakeIlkValues[vat.IlkRate].(string),
				Art:  blockOneFakeIlkValues[vat.IlkArt].(string), // hasn't been updated since block 1
				Spot: blockThreeFakeIlkValues[vat.IlkSpot].(string),
				Line: blockThreeFakeIlkValues[vat.IlkLine].(string),
			}
		...
		It("gets more than one ilk as of block three", func() {
			...
			test_helpers.CreateIlk(db, headerOne, blockOneAnotherFakeIlkState, test_helpers.AnotherFakeIlkVatMetadatas, test_helpers.EmptyMetadatas, test_helpers.EmptyMetadatas, test_helpers.EmptyMetadatas)
			...
			blockThreeFakeIlkValues := test_helpers.GetIlkValues(3)
			vatMetadatasWithoutRate := []vdbStorage.StorageValueMetadata{test_helpers.FakeIlkArtMetadata, test_helpers.FakeIlkSpotMetadata, test_helpers.FakeIlkLineMetadata}
			...
			blockThreeExpectedFakeIlk := test_helpers.IlkState{
				...
				Rate:          blockOneFakeIlkValues[vat.IlkRate].(string), // value hasn't changed since block 1
				Art:           blockThreeFakeIlkValues[vat.IlkArt].(string),
				Spot:          blockThreeFakeIlkValues[vat.IlkSpot].(string),
				Line:          blockThreeFakeIlkValues[vat.IlkLine].(string),
			}
			blockThreeExpectedAnotherFakeIlk := test_helpers.IlkState{
				IlkIdentifier: test_helpers.AnotherFakeIlk.Identifier,
				Rate:          blockOneAnotherFakeIlkState[vat.IlkRate].(string), // value hasn't changed since block 1
				Art:           blockOneAnotherFakeIlkState[vat.IlkArt].(string),  // value hasn't changed since block 1
				Spot:          blockOneAnotherFakeIlkState[vat.IlkSpot].(string), // value hasn't changed since block 1
				Line:          blockOneAnotherFakeIlkState[vat.IlkLine].(string), // value hasn't changed since block 1
			}
	...
	It("returns the rest of the Ilk data if a field has missing data", func() {
		...
		test_helpers.CreateIlk(db, headerOne, blockOneFakeIlkValues, vatMetadatasWithoutRate, test_helpers.FakeIlkCatMetadatas, test_helpers.FakeIlkJugMetadatas, test_helpers.FakeIlkSpotMetadatas)
	...
	It("gets the correct timestamps", func() {
		...
		blockTwoFakeIlkValues := test_helpers.GetIlkValues(1)
		test_helpers.CreateIlk(db, headerTwo, blockTwoFakeIlkValues, test_helpers.EmptyMetadatas, test_helpers.EmptyMetadatas, test_helpers.FakeIlkJugMetadatas, test_helpers.EmptyMetadatas)

		blockTwoAnotherFakeIlkValues := test_helpers.GetIlkValues(2)
		test_helpers.CreateIlk(db, headerTwo, blockTwoAnotherFakeIlkValues, test_helpers.EmptyMetadatas, test_helpers.EmptyMetadatas, test_helpers.AnotherFakeIlkJugMetadatas, test_helpers.EmptyMetadatas)
