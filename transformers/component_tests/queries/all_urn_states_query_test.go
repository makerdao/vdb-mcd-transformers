...
var _ = Describe("Urn history query", func() {
	...
	It("returns a reverse chronological history for the given ilk and urn", func() {
		...
		wrongMetadata := vdbStorage.GetStorageValueMetadata(vat.UrnArt,
			map[vdbStorage.Key]string{constants.Ilk: helper.FakeIlk.Hex, constants.Guy: wrongUrn}, vdbStorage.Uint256)
