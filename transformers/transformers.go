...
import (
	...
	"github.com/vulcanize/mcd_transformers/transformers/deal"
	...
	"github.com/vulcanize/mcd_transformers/transformers/flap_kick"
	"github.com/vulcanize/mcd_transformers/transformers/flip_kick"
	"github.com/vulcanize/mcd_transformers/transformers/flop_kick"
	"github.com/vulcanize/mcd_transformers/transformers/frob"
	"github.com/vulcanize/mcd_transformers/transformers/pit_file/debt_ceiling"
	"github.com/vulcanize/mcd_transformers/transformers/pit_file/ilk"
	"github.com/vulcanize/mcd_transformers/transformers/price_feeds"
	"github.com/vulcanize/mcd_transformers/transformers/tend"
	"github.com/vulcanize/mcd_transformers/transformers/vat_flux"
	"github.com/vulcanize/mcd_transformers/transformers/vat_fold"
	"github.com/vulcanize/mcd_transformers/transformers/vat_grab"
	"github.com/vulcanize/mcd_transformers/transformers/vat_heal"
	"github.com/vulcanize/mcd_transformers/transformers/vat_init"
	"github.com/vulcanize/mcd_transformers/transformers/vat_move"
	"github.com/vulcanize/mcd_transformers/transformers/vat_slip"
