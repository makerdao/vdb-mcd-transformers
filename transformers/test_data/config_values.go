...
func ClipCrvv1ethstethAV1110Address() string {
	return checksum(constants.GetContractAddress("MCD_CLIP_CRVV1ETHSTETH_A_1_11_0"))
}
...
func ClipMaticAV180Address() string {
	return checksum(constants.GetContractAddress("MCD_CLIP_MATIC_A_1_9_4"))
}

func ClipRenbtcAV160Address() string {
	return checksum(constants.GetContractAddress("MCD_CLIP_RENBTC_A_1_6_0"))
}
func ClipRethAV160Address() string {
	return checksum(constants.GetContractAddress("MCD_CLIP_RETH_A_15_11_22"))
}
func ClipGnoAV160Address() string {
	return checksum(constants.GetContractAddress("MCD_CLIP_GNO_A_12_16_22"))
}
...
func ClipWstethAV198Address() string {
	return checksum(constants.GetContractAddress("MCD_CLIP_WSTETH_A_1_9_8"))
}
...
func Clip180Addresses() []string {
	...
	clipAddresses := constants.GetContractAddresses([]string{
		...
		"MCD_CLIP_CRVV1ETHSTETH_A_1_11_0",
...
func ClipWbtcCV1911Address() string {
	return checksum(constants.GetContractAddress("MCD_CLIP_WBTC_C_1_9_11"))
}
...
func MedianGnoAddress() string  { return checksum(constants.GetContractAddress("MEDIAN_GNO_12_16_22")) }
...
func OsmGnoAddress() string     { return checksum(constants.GetContractAddress("OSM_GNO")) }
...
func OsmWstethAddress() string  { return checksum(constants.GetContractAddress("OSM_WSTETH")) }
