...
func (repository JugStorageRepository) Create(diffID, headerID int64, metadata vdbStorage.StorageValueMetadata, value interface{}) error {
...
func (repository JugStorageRepository) insertIlkRho(diffID, headerID int64, metadata vdbStorage.StorageValueMetadata, rho string) error {
...
func (repository JugStorageRepository) insertIlkDuty(diffID, headerID int64, metadata vdbStorage.StorageValueMetadata, duty string) error {
	ilk, err := getIlk(metadata.Keys)
	if err != nil {
		return err
	}
