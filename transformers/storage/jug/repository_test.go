	...
	Describe("Ilk", func() {
		Describe("Rho", func() {
			It("writes a row", func() {
				ilkRhoMetadata := vdbStorage.GetStorageValueMetadata(jug.IlkRho, map[vdbStorage.Key]string{constants.Ilk: test_helpers.FakeIlk.Hex}, vdbStorage.Uint256)
			...
			It("returns an error if metadata missing ilk", func() {
				malformedIlkRhoMetadata := vdbStorage.GetStorageValueMetadata(jug.IlkRho, nil, vdbStorage.Uint256)
			...
			shared_behaviors.SharedIlkTriggerTests(shared_behaviors.IlkTriggerTestInput{
				Repository:    &repo,
				Metadata:      vdbStorage.GetStorageValueMetadata(jug.IlkRho, map[vdbStorage.Key]string{constants.Ilk: test_helpers.FakeIlk.Hex}, vdbStorage.Uint256),
				PropertyName:  "Rho",
		...
		Describe("Duty", func() {
			It("writes a row", func() {
				ilkDutyMetadata := vdbStorage.GetStorageValueMetadata(jug.IlkDuty, map[vdbStorage.Key]string{constants.Ilk: test_helpers.FakeIlk.Hex}, vdbStorage.Uint256)
			...
			It("returns an error if metadata missing ilk", func() {
				malformedIlkDutyMetadata := vdbStorage.GetStorageValueMetadata(jug.IlkDuty, nil, vdbStorage.Uint256)
			...
			shared_behaviors.SharedIlkTriggerTests(shared_behaviors.IlkTriggerTestInput{
				Repository:    &repo,
				Metadata:      vdbStorage.GetStorageValueMetadata(jug.IlkDuty, map[vdbStorage.Key]string{constants.Ilk: test_helpers.FakeIlk.Hex}, vdbStorage.Uint256),
				PropertyName:  "Duty",
				PropertyValue: strconv.Itoa(rand.Int()),
