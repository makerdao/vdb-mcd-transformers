...
var _ = Describe("Cat storage repository", func() {
	var (
		...
		repo                 v1_0_10.StorageRepository
	...
	BeforeEach(func() {
		...
		repo = v1_0_10.StorageRepository{ContractAddress: test_data.CatAddress()}
		repo.SetDB(db)
	...
	Describe("Variable", func() {
		...
		Describe("Box", func() {
			boxMetadata := types.GetValueMetadata(v1_0_10.Box, nil, types.Uint256)
			inputs := shared_behaviors.StorageBehaviorInputs{
				ValueFieldName: v1_0_10.Box,
				Value:          fakeUint256,
		...
		Describe("Litter", func() {
			litterMetadata := types.GetValueMetadata(v1_0_10.Litter, nil, types.Uint256)
			inputs := shared_behaviors.StorageBehaviorInputs{
				ValueFieldName: v1_0_10.Litter,
				Value:          fakeUint256,
				Schema:         constants.MakerSchema,
		...
		Describe("Live", func() {
			liveMetadata := types.GetValueMetadata(v1_0_10.Live, nil, types.Uint256)
			inputs := shared_behaviors.StorageBehaviorInputs{
				ValueFieldName: v1_0_10.Live,
				Value:          fakeUint256,
				Schema:         constants.MakerSchema,
		...
		Describe("Vat", func() {
			vatMetadata := types.GetValueMetadata(v1_0_10.Vat, nil, types.Address)
			inputs := shared_behaviors.StorageBehaviorInputs{
				ValueFieldName: v1_0_10.Vat,
				Value:          fakeAddress,
				Schema:         constants.MakerSchema,
		...
		Describe("Vow", func() {
			vowMetadata := types.GetValueMetadata(v1_0_10.Vow, nil, types.Address)
			inputs := shared_behaviors.StorageBehaviorInputs{
				ValueFieldName: v1_0_10.Vow,
				Value:          fakeAddress,
				Schema:         constants.MakerSchema,
	...
	Describe("Ilk", func() {
		...
		Describe("Flip", func() {
			It("writes a row", func() {
				ilkFlipMetadata := types.GetValueMetadata(v1_0_10.IlkFlip, map[types.Key]string{constants.Ilk: test_helpers.FakeIlk.Hex}, types.Address)
			...
			It("returns an error if metadata missing ilk", func() {
				malformedIlkFlipMetadata := types.GetValueMetadata(v1_0_10.IlkFlip, map[types.Key]string{}, types.Address)
			...
			shared_behaviors.SharedIlkTriggerTests(shared_behaviors.IlkTriggerTestInput{
				Repository:    &repo,
				Metadata:      types.GetValueMetadata(v1_0_10.IlkFlip, map[types.Key]string{constants.Ilk: test_helpers.FakeIlk.Hex}, types.Address),
				PropertyName:  "Flip",
		...
		Describe("Chop", func() {
			It("writes a row", func() {
				ilkChopMetadata := types.GetValueMetadata(v1_0_10.IlkChop, map[types.Key]string{constants.Ilk: test_helpers.FakeIlk.Hex}, types.Uint256)
			...
			It("returns an error if metadata missing ilk", func() {
				malformedIlkChopMetadata := types.GetValueMetadata(v1_0_10.IlkChop, map[types.Key]string{}, types.Uint256)
			...
			shared_behaviors.SharedIlkTriggerTests(shared_behaviors.IlkTriggerTestInput{
				Repository:    &repo,
				Metadata:      types.GetValueMetadata(v1_0_10.IlkChop, map[types.Key]string{constants.Ilk: test_helpers.FakeIlk.Hex}, types.Uint256),
				PropertyName:  "Chop",
		...
		Describe("Lump", func() {
			It("writes a row", func() {
				ilkLumpMetadata := types.GetValueMetadata(v1_0_10.IlkLump, map[types.Key]string{constants.Ilk: test_helpers.FakeIlk.Hex}, types.Uint256)
			...
			It("returns an error if metadata missing ilk", func() {
				malformedIlkLumpMetadata := types.GetValueMetadata(v1_0_10.IlkLump, map[types.Key]string{}, types.Uint256)
			...
			shared_behaviors.SharedIlkTriggerTests(shared_behaviors.IlkTriggerTestInput{
				Repository:    &repo,
				Metadata:      types.GetValueMetadata(v1_0_10.IlkLump, map[types.Key]string{constants.Ilk: test_helpers.FakeIlk.Hex}, types.Uint256),
				PropertyName:  "Lump",
				PropertyValue: strconv.Itoa(rand.Int()),
				Schema:        constants.MakerSchema,
