...
var _ = Describe("Cat storage keys loader", func() {
	...
	BeforeEach(func() {
		storageRepository = &test_helpers.MockMakerStorageRepository{}
		storageKeysLoader = v1_0_0.NewKeysLoader(storageRepository, test_data.CatAddress())
	})
	...
	It("returns value metadata for static keys", func() {
		...
		Expect(mappings[v1_0_0.LiveKey]).To(Equal(v1_0_0.LiveMetadata))
		Expect(mappings[v1_0_0.VatKey]).To(Equal(v1_0_0.VatMetadata))
		Expect(mappings[v1_0_0.VowKey]).To(Equal(v1_0_0.VowMetadata))
	})
	...
	Describe("ilk", func() {
		...
		Describe("when getting ilks succeeds", func() {
			var (
				ilkFlipKey = common.BytesToHash(crypto.Keccak256(common.FromHex(test_helpers.FakeIlk + v1_0_0.IlksMappingIndex)))
