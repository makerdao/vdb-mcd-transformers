...
var StorageTransformerInitializer storage.TransformerInitializer = storage.Transformer{
	...
	StorageKeysLookup: storage.NewKeysLookup(median.NewKeysLoader(&mcdStorage.MakerStorageRepository{}, medianizerAddress)),
	Repository:        &median.MedianizerStorageRepository{ContractAddress: medianizerAddress},
}.NewTransformer
