...
func (Transformer) toEntities(contractAbi string, logs []core.EventLog) ([]LogDeleteEntity, error) {
	var entities []LogDeleteEntity

	for _, log := range logs {
		var entity LogDeleteEntity
		...
		unpackErr := contract.UnpackLog(&entity, "LogDelete", log.Log)
		if unpackErr != nil {
